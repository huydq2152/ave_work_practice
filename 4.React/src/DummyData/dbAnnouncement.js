...
export const announcements = [
  {
    ...
    content:
      "The slow and clumsy Russian campaign for the south has been the most baffling. It is clear what Moscow wants: To cut off Ukraine's access to the Black Sea. What is hard to fathom is whether the Kremlin's plan to get it has collapsed, and Russian troops are just throwing rockets and tanks at anything they can, or whether this sort of total war against Ukrainians was always the plan.",
